# Design Automation script which accept directory name from user and create log file in that directory display information of running processes as its name, PID, Username
